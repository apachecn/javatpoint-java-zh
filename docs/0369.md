...
> 原文:[https://www.javatpoint.com/javafx-parallel-transition](https://www.javatpoint.com/javafx-parallel-transition)

此过渡会在一个节点上并行应用多个动画。它类似于顺序转换，只是它同时在节点上应用多个转换，而顺序转换按照动画传递到构造函数的顺序在节点上应用多个转换。

在 JavaFX 中，类**JavaFX . animation . parallel transition**代表并行转换。我们只需要在实例化这个类时将转换列表传递给构造函数。
...
![JavaFX Parallel Transition](../Images/b7d029bf487daec669f76c7528495bda.png)
...
![JavaFX Parallel Transition](../Images/8ee1d77a78848fedd54991fa445c6102.png)