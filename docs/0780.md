...
![Implementing HATEOAS for RESTful Services](../Images/ddbf0a9c4e7e11ef159d9835e4b36d01.png)

在这里我们可以看到，它返回用户以及访问所有用户的链接。现在点击链接，再次发送 GET 请求。它返回所有用户的列表，如下图所示。

![Implementing HATEOAS for RESTful Services](../Images/421d26bcba8ab0b96e9659db73c27846.png)
