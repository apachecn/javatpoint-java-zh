...
> 原文:[https://www.javatpoint.com/java-get-current-date](https://www.javatpoint.com/java-get-current-date)
...
#### 注意:在经典的日期应用编程接口中，建议使用日历类来获取当前的日期和时间。从 Java 8 开始，您可以使用 LocalDate、LocalTime 或 LocalDateTime 类。
