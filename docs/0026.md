...
## 16) [鸭号 Java](duck-number-java)

## 17) [恶数 Java](evil-number-java)

## 18) [ISBN 号 Java](isbn-number-java)

## 19) [克氏数 Java](krishnamurthy-number-java)
...
## 24) [Java 木质部和韧皮部数量](xylem-and-phloem-number-in-java)
...
## 2) [Java 二分搜索法](binary-search-in-java)
