...
> 原文:[https://www.javatpoint.com/java-treeset](https://www.javatpoint.com/java-treeset)

![TreeSet class hierarchy](../Images/567dde817fa173878b224f58e62b1adf.png)

Java TreeSet 类实现了使用树进行存储的 Set 接口。它继承了抽象集合类并实现了导航集合接口。TreeSet 类的对象以升序存储。
