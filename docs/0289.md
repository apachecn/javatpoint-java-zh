...
> 原文:[https://www.javatpoint.com/notepad](https://www.javatpoint.com/notepad)

**带源代码的 java 记事本:**我们可以借助带有事件处理的 AWT/Swing 开发 Java 记事本。让我们看看用 java 创建记事本的代码。
...
[download this example](https://static.javatpoint.com/src/swing/Notepad.zip)![Java Notepad with Source Code](../Images/4be6da9efda319d8772b8346a25a64f3.png)