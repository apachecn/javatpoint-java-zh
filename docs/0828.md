...
> 原文:[https://www.javatpoint.com/spring-aop-example](https://www.javatpoint.com/spring-aop-example)
...
![spring aop advice interfaces](../Images/1d34b93b9b7fab1b1c1e472203dc6e62.png)
...
我们可以打印附加信息，如方法名、方法参数、目标对象、目标对象类名、代理类等。
