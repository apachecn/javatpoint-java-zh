# 非字符串集合的构造函数注入(具有依赖对象)示例

> 原文:[https://www . javatpoint . com/spring-教程-构造函数-注入-带非字符串-集合](https://www.javatpoint.com/spring-tutorial-constructor-injection-with-non-string-collection)
