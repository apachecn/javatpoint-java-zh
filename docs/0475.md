...
> 原文:[https://www.javatpoint.com/java-long-to-string](https://www.javatpoint.com/java-long-to-string)

我们可以使用 *String.valueOf()* 和 *Long.toString()* 方法将 java 中的 **long 转换为 String。**

![Java Convert long to String](../Images/ec097adee7be77e1df1aa803b68aa249.png)
