...
> 原文:[https://www.javatpoint.com/tic-tac-toe-game](https://www.javatpoint.com/tic-tac-toe-game)

在这个例子中，我们将看到井字游戏的例子(也称为 0 和 x(十字))。

它只能通过 AWT api 开发，但是我们这里使用的是 swing 框架。
...
[download this example](https://static.javatpoint.com/src/swing/Tic.zip)