...
> 原文:[https://www . javatpoint . com/hibernate-每层次表格-示例-使用-XML-文件](https://www.javatpoint.com/hibernate-table-per-hierarchy-example-using-xml-file)
...
![table per class hierarchy in inhertance mapping](../Images/1ee88d8a251b98174368673d823b622f.png)
...
![table per class hierarchy table](../Images/358fc3f8e28ba4bfaf217a5ea33d6079.png)
...
![output of the table per class hierarchy](../Images/08216440bcc2d9f215299ac431297175.png)
