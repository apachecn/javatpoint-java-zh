...
> 原文:[https://www.javatpoint.com/spring-boot-jpa](https://www.javatpoint.com/spring-boot-jpa)
...
![Spring Boot jpa](../Images/8e3d73f83858f74477051c4d53874215.png)

## JPA 类关系

我们上面讨论的类和接口保持着一种关系。下图显示了类和接口之间的关系。

![Spring Boot jpa](../Images/bbc47a9db7867da0f1bf14c26e142e45.png)
...
![Spring Boot jpa](../Images/2689745d66cfcbcb1af475be2ed6990f.png)
...
![Spring Boot jpa](../Images/bed4888212f1ebf08c46daf5ff2e8033.png)
...
![Spring Boot jpa](../Images/08e743b28a593ea224e0a9f9d93908c8.png)
...
![Spring Boot jpa](../Images/945b7c2762d7e3c5c45a2c191f344eb3.png)

当我们点击发送按钮时，它显示**状态:200 OK** 。这意味着请求已成功执行。

**第 21 步:**打开浏览器，调用 URL http://localhost:8080。它返回我们在数据库中插入的用户。

![Spring Boot jpa](../Images/b8fcde78361f88b40ae782b8f5513fec.png)
