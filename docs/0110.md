...
> 原文:[https://www.javatpoint.com/java-string-tolowercase](https://www.javatpoint.com/java-string-tolowercase)

**java 字符串 toLowerCase()** 方法返回小写字母的字符串。换句话说，它将字符串的所有字符转换成小写字母。
