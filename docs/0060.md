...
> 原文:[https://www.javatpoint.com/object-cloning](https://www.javatpoint.com/object-cloning)

![constructor in java](../Images/2b7b9b91d5d8c7c7dc85a26c248c1e89.png)对象克隆是一种创建对象精确副本的方法。对象类的 clone()方法用于克隆对象。
