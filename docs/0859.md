...
> 原文:[https://www.javatpoint.com/spring-mvc-crud-example](https://www.javatpoint.com/spring-mvc-crud-example)
...
![Spring MVC CRUD Example](../Images/0f96a41a783a4d5b99550110ed7891f6.png)
...
![Spring MVC CRUD Example](../Images/645452ea34207d3f9ff2f5388fc3507a.png)

点击**添加员工**，会看到如下表格。

![Spring MVC CRUD Example](../Images/4bbd52f630bb50e224f39af8fc4c8eee.png)

填好表格后**点击**保存，将条目添加到数据库中。

![Spring MVC CRUD Example](../Images/83a1921916f91e95471187cd75993dd5.png)

现在，点击**编辑**对提供的数据进行一些修改。

![Spring MVC CRUD Example](../Images/160656dbdb393b02e03ab2d6aefa0cdf.png)

现在，点击**编辑保存**将修改后的条目添加到数据库中。

![Spring MVC CRUD Example](../Images/ff05f2dd872d787ebd38f1eb8f8f9573.png)

现在，点击**删除**从数据库中删除该条目。

![Spring MVC CRUD Example](../Images/b03d2a061fda7e46f4b9c979ecdd2415.png)
