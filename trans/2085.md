...
> 原文:[https://www . javatpoint . com/restful-web-services-动态-过滤](https://www.javatpoint.com/restful-web-services-dynamic-filtering)
...
![Implementing Dynamic Filtering for RESTful Services](../Images/c58cc40f9720a11b051d66dc6b3d11cb.png)

同样，发送一个带有 URI http://localhost:8080/过滤列表的 GET 请求。它在响应中返回一个包含两个字段名称和电话的列表，如下图所示。

![Implementing Dynamic Filtering for RESTful Services](../Images/67d437617aafdbd5f43d6149403ff051.png)
